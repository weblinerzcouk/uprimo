                                            ...
                                            <tr id="row{{$ads_row->id}}">
                                                ...
                                                <td>
                                                    @if($ads_row->status==1)
                                                        ...
                                                        <a data-toggle="active_ad" href="{{url('/admin/active_ad/'.$ads_row->id)}}">InActive</a>
                                                        @else
                                                        <label class="label label-danger">InActive</label><br>
                                                        <a data-toggle="active_ad" href="{{url('/admin/active_ad/'.$ads_row->id)}}">Active</a>
                                                        @endif
                                                </td>
                                                <td>
...
<script type="text/javascript">
    $(document).on('click','a[data-toggle=active_ad]',function (e) {
        e.preventDefault();
        var str = '';
        $.ajax({
            url         : $(this).attr('href'),
            ...
            success     : function (result) {
                $.each(result,function (i,item) {
                    if(item.status==1)
                    {
                        var dbtn = '<label class="label label-success">Active</label><br> <a data-toggle="active_ad" href="/admin/active_ad/'+item.id+'">InActive</a>'
                    }
                    else{
                        var dbtn = '<label class="label label-danger">Inactive</label><br> <a data-toggle="active_ad" href="/admin/active_ad/'+item.id+'">Active</a>'
                    }
