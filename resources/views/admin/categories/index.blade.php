        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 add-new-btn">
                    <a type="button" class="btn btn-success pull-right" href="{{url('/admin/add_category')}}" data-toggle="add_new" >
                        + Add New
                    </a>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped border white-box">
                                    ...
                                    <tr id="row{{$category_row->id}}">
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="{{url('/admin/edit_category/'.$category_row->id)}}" data-toggle="edit_category">
                                                <span class="fa fa-pencil"></span>
                                            </a>
                                            <a class="btn btn-danger" href="{{url('/admin/delete_category/'.$category_row->id)}}" data-toggle="delete_category">
...
<script>
    ...
    $(document).on('click','a[data-toggle=edit_category]',function (e) {
        e.preventDefault();
        $('#edit_modal').find('.modal-body').load($(this).attr('href'));
        $('#edit_modal').modal('show');
    });
    //delete_country
    $(document).on('click','a[data-toggle=delete_category]',function (e) {
        e.preventDefault();
        var str = '';
        $.ajax({
            url         : $(this).attr('href'),
