<div class="white-box p-2">
    <form id="add_attribute_form" class="form-horizontal form-material" method="post" action="{{url('/admin/save_attribute')}}">
       @csrf
        <div class="form-group">
            <label class="col-md-12">ID</label>
            <div class="col-md-12">
                <input type="text" placeholder="ID" class="form-control form-control-line" name="attribute_id" value="{{$attribute_id}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" placeholder="Attribute Name" class="form-control form-control-line" name="attribute_name">
            </div>
        </div>
        <div class="form-group">
...
<script type="text/javascript">
    $('#add_attribute_form').submit(function () {
