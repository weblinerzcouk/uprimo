            ...
            <tr>
              <td valign="top" class="wrap-cell" style="padding-top:30px; padding-bottom:30px;">
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="60" valign="top" class="header-cell" style="padding: 20px;">
                      <img src="http://utopiaacademy.co.uk/darcy_email_content/logo_uprimo.png" width="250px" alt="logo">
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Welcome to Uprimo</h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hey 'Name',</b><br>
                            Thank you for registering with Uprimo! We are very pleased that you have chosen us for your Classified Listings.<br>
                            So what’s the next step?<br>Now that you have registered you can now enter your details and post classified ads for your products.<br>But first, please click the below button to active your account.
                          </td>
                        </tr>
                        <tr>
                              ...
                              <tr>
                                <td style="width:200px;background:#008000;">
                                  <div><!--[if mso]>
                                    ...
                                    <![endif]-->
                                        <a href="{{$url}}"
                                  style="background-color:#e59a24;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Activate Account</a>
                                    <!--[if mso]>
                                      </center>
                                    </v:rect>
                                  <![endif]--></div>
                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            If you are having an issues with your account, please don't hesitate to contact us by replying to this email.
                          </td>
                        </tr>
                        <tr>
