                                 ...
                                 <div class="sidebar-block collection-block">
                                    ...
                                    <div class="sidebar-content">
                                       <ul class="list-cat">
                                          ...
                                          <li><a href="#">Maybe You Prefer </a></li>
                                          <li><a href="#">New Products </a></li>
                                          <li><a href="#">Sport </a></li>
                                          <li><a href="#">Today's Trending </a></li>
                                       </ul>
                                    </div>
                                 </div>
                                       ...
                                       <div class="filter-tag-group">
                                          <div class="tag-group" id="coll-filter-3">
                                             ...
                                             <ul class="filter-content">
                                                ...
                                                <li><a href="#" title="Narrow selection to products matching brand 2"><span class="fe-checkbox"></span> Master Chef (346)</a></li>
                                                <li><a href="#" title="Narrow selection to products matching brand 3"><span class="fe-checkbox"></span> DMWD (600)</a></li>
                                                <li><a href="#" title="Narrow selection to products matching brand 4"><span class="fe-checkbox"></span> MI (346)</a></li>
                                                <li><a href="#" title="Narrow selection to products matching brand 5"><span class="fe-checkbox"></span> Allwin (600)</a></li>
                                             </ul>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="collection-items clearfix">
                                    <div class="products">
                                       ...
                                       <div class="product-item col-sm-3">
                                          <div class="product">
                                             <div class="row-left">
                                                <a href="product-details.html" class="hoverBorder container_item">
                                                   <div class="hoverBorderWrapper">
                                                      <img src="{{asset('/images/ads/'.$ads_row->id.'/'.$ads_row->display_pic)}}" class="img-responsive front" alt="Digital equipment">
                                                      <div class="mask"></div>
                                                   </div>
                                                </a>
                                             ...
                                             <div class="row-right animMix">
                                                ...
                                                <div class="list-mode hide">
                                                   <div class="list-left">
                                                      <div class="classified_electronics_detail.html"><a class="title-5" href="classified_electronics_detail.html">Digital equipment</a></div>
                                                      <div class="rating-star">
                                                         <span class="spr-badge" data-rating="5.0"><span class="spr-starrating spr-badge-starrating"><i class="fa fa-star" style=""></i><i class="fa fa-star" style=""></i><i class="fa fa-star" style=""></i><i class="fa fa-star" style=""></i><i class="fa fa-star" style=""></i></span><span class="spr-badge-caption">1 review</span>
                                                         </span>
                                                      </div>
